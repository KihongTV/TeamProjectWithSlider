...
function aboutus() {
  return (
    ...
    className="mySwiper ">
      <SwiperSlide>
             <header className='relative flex flex-col items-baseline'  style={{height:'fit-content'}}>
           
            
           <Nav></Nav>
           <motion.section initial={{ y: 10, opacity: 0 }} exit={{ y: -10, opacity: 0 }} animate={{opacity:1,y:0}}   transition={{
                           duration: 1,
                    delay: 0.2}} className='flex flex-col justify-center h-full  container mx-auto lg:mt-12 mt-0  items-center text-white'>
                <img src='../img/teamsvg.svg' width={300} height={300}></img>
               ...
               <p className='font-semibold  md:mt-9 mt-4 text-slate-400 text-sm px-2 md:px-0 sm:text-lg max-w-[500px]'>تیم ما در سال 1398 تاسیس شد و هر روزه ما در تلاشیم که تیم خودمون رو قوی کنیم تا بتوانیم همگی با هم پیشرفت کنیم و تبدیل به اون چیزی که میخوایم بشیم . تیم ما دارای مهارت هایی مثل برنامه نویس های دیتا ساینس و فلاتر و ریکت و سی شارپ و طراحان گرافیکی هست و دوست داریم بتونیم کاری کنیم که بتونیم بیزینس شمارو رونق بدیم </p>
                <h6 className='text-center max-w-[500px] font-bold text-2xl mt-2'>مارا در شبکه های مجازی دنبال کنید</h6>
               <div className="flex justify-center xl:justify-center max-w-[500px] py-1 mb-3">
